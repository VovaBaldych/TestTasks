...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Янв 10 2020 г., 19:10
...
INSERT INTO `task_list` (`task_list_id`, `user_id`, `name_user`, `email`, `task_details`, `task_status`) VALUES
(14, 1, 'Хрущ', 'vovabaldych@gmail.com', 'Поїсти', 'no'),
(15, 1, 'John', 'vovabaldych@gmail.com', 'сходити в туалет', 'no');
...
--
ALTER TABLE `task_list`
  MODIFY `task_list_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
COMMIT;
